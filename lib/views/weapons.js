define([
    ...
    var WeaponsView = Marionette.ItemView.extend({
        ...
        model: [
                {name:'Atomic Fire',     boss:'Heatman',   p:1, have:false},
                {name:'Air Shooter',     boss:'Airman',    p:2, have:false},
                {name:'Leaf Shield',     boss:'Woodman',   p:4, have:false},
                {name:'Bubble Lead',     boss:'Bubbleman', p:8, have:false},
                {name:'Quick Boomerang', boss:'Quickman',  p:16, have:false},
                {name:'Time Stopper',    boss:'Flashman',  p:32, have:false},
                {name:'Metal Blade',     boss:'Metalman',  p:64, have:false},
                {name:'Crash Bomb',      boss:'Crashman',  p:128, have:false}
        ],
